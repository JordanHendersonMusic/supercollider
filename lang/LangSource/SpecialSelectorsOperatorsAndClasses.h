...
// Note: this is not an extensive list of all the special selectors, operators or classes, but represent the raw enum
// used to represent them. In future, some refactoring should be done to unify these into separate documents so it is
